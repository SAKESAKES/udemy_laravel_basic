            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form class="mb-8" method="get" action="{{ route('contacts.index')}}">
                      ...
                      <button class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索する</button> <!-- お問い合わせ一覧の検索フォーム作成-->
                    </form>
                      ...
                      <table class="table-auto w-full text-left whitespace-no-wrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="border-t-2 border-gray-200 px-4 py-3"><a class="text-blue-500" <a href ="{{ route('contacts.show', ['id' => $contact->id ])}}">詳細を見る</a></td> {{-- 名前付きルート --}}
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
