                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                              <div class="p-2 w-full">
                                ...
                                </div>                                     {{--vallidationに引っかかっても、入力した文字が残る--}}
                              </div>
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <input type="emali" id="email" name="email" value="{{ old('email') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                              </div>
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <select name="age">
                                    ...
                                    <option value="1" {{ old('age') == 1 ? 'checked' : ''}}>~19歳</option>
                                    <option value="2" {{ old('age') == 2 ? 'checked' : ''}}>20歳～29歳</option>
                                    <option value="3" {{ old('age') == 3 ? 'checked' : ''}}>30歳～39歳</option>
                                    <option value="4" {{ old('age') == 4 ? 'checked' : ''}}>40歳～49歳</option>
                                    <option value="5" {{ old('age') == 5 ? 'checked' : ''}}>50歳～59歳</option>
                                    <option value="6" {{ old('age') == 6 ? 'checked' : ''}}>60歳～</option>
                                  </select>
                                </div>
                              </div>
